            ...
            <div className="bg-white rounded-xl p-6 shadow-2xl">
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div className="space-y-2">
                  ...
                  <select className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-2 focus:ring-accent-gold focus:border-transparent bg-gray-50">
                ...
                <div className="flex items-end">
                  <Button
                    onClick={() => {
                      ...
                      // Add other filters if needed later
                      navigate(`/leiloes?${params.toString()}`);
                    }}
